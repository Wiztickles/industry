                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="first_name" type="text" class="form-control" name="first_name" placeholder="John" value="{{ old('first_name') }}">
                        ...
                        <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="last_name" type="text" class="form-control" name="last_name" placeholder="Smith" value="{{ old('last_name') }}">
                        ...
                        <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" type="tel" class="form-control" name="phone_number" placeholder="021123456" value="{{ old('phone_number') }}">
